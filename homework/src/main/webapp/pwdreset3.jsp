...
<body>
	...
	<div class="container" style="width: 400px; margin-top:10%;">
		...
		<form method="post" action="pwdReset3.do" style="margin-top:15%;">
			...
			<div class="form-group">
			 ...
			 <div style="text-align: center;">
				<input class="btn btn btn-primary" type="button" value="上一步" onclick="javascript:window.location.href ='pwdreset2.jsp'">
