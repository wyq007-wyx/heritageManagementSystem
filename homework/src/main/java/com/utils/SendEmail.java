...
public class SendEmail {
    public static String sendEmailAccount = "qiyeswinner@163.com";
    public static String sendEmailPassword = "TKNNVJJBUZJLOCBB";
    ...
    public void sendMail(String receiveMailAccount, String mailContent) {
        ...
        try {
            ...
            transport.connect(sendEmailSMTPHost,25,sendEmailAccount, sendEmailPassword);
